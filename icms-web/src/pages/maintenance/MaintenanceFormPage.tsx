          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {isEditMode && (
                  <p className="text-xs text-gray-500 mt-1">Craftsman cannot be changed</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {isEditMode && (
                  <p className="text-xs text-gray-500 mt-1">Work order cannot be changed</p>
                )}
              </div>
          ...
          <div className="pt-6 border-t">
            ...
            <div className="space-y-4">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                />
                <div>
                  <span className="text-sm font-medium text-gray-900">Equipment Operational</span>
                  <p className="text-xs text-gray-500">Check if equipment is operational after maintenance</p>
                </div>
              </label>
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Check if additional work or inspection is needed</p>
                </div>
              </label>
            </div>
          </div>
