      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6">
        <div className="space-y-6">
          ...
          <div className="pt-6 border-t">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Quantity & Stock Levels</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
          ...
          {/* Costing & Location */}
          <div className="pt-6 border-t">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Costing & Location</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
          ...
          {/* Batch Tracking */}
          <div className="pt-6 border-t">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Batch Tracking (Optional)</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
