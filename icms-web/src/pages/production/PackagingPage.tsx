...
const PackagingPage: React.FC = () => {
  ...
  const getStatusBadge = (status: ProductionOrderStatus) => {
    const badges = {
      ...
      paused: { bg: 'bg-orange-100', text: 'text-orange-800', icon: Clock },
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Packaging Orders</h1>
            <p className="text-gray-600 mt-1">Manage packaging and final product preparation</p>
          </div>
        ...
        {statistics && (
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div className="bg-white rounded-lg shadow p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600">Total Packaged</p>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        {isLoading ? (
          <div className="p-8 text-center">
            ...
            <p className="mt-4 text-gray-600">Loading packaging orders...</p>
          </div>
        ) : orders.length === 0 ? (
          <div className="p-8 text-center">
            <PackageCheck className="w-12 h-12 text-gray-400 mx-auto mb-3" />
            <p className="text-gray-600">No packaging orders found</p>
          </div>
        ) : (
          <>
                  ...
                  {orders.map((order) => {
                    ...
                    return (
                      <tr key={order.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">{order.packaging_type || '-'}</div>
