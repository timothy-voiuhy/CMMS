    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg shadow p-4">
          ...
          <p className="text-2xl font-bold text-gray-900">P{order.priority}</p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-600">Produced Quantity</p>
                  <p className="text-sm font-medium text-gray-900 mt-1">
              ...
              {order.completion_notes && (
                <div>
                  ...
                  <p className="text-sm text-gray-900 mt-1">{order.completion_notes}</p>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900 mt-1">{line.name}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Line Code</p>
                  <p className="text-sm font-medium text-gray-900 mt-1">{line.line_code}</p>
                </div>
                {line.location && (
                  <div>
                    <p className="text-sm text-gray-600">Location</p>
                    <p className="text-sm font-medium text-gray-900 mt-1">{line.location}</p>
                  </div>
                )}
                <button
