...
export const ROLE_TEMPLATES: Record<string, { name: string; description: string; level: number; category: string; permissions: string[] }> = {
  ...
  production_manager: { name: 'Production Manager', description: 'Manages production operations', level: 9, category: 'Management', permissions: ['dashboard.view', 'production.*', 'equipment.view', 'equipment.assign', 'inventory.view', 'inventory.transaction', 'quality.view', 'maintenance.view', 'work_orders.view', 'work_orders.assign', 'craftsmen.view', 'reports.view', 'reports.production', 'reports.equipment', 'reports.export'] },
  quality_manager: { name: 'Quality Manager', description: 'Manages quality assurance operations', level: 9, category: 'Management', permissions: ['dashboard.view', 'quality.*', 'production.view', 'inventory.view', 'reports.view', 'reports.quality', 'reports.production', 'reports.export', 'craftsmen.view'] },
  maintenance_manager: { name: 'Maintenance Manager', description: 'Manages maintenance operations', level: 8, category: 'Management', permissions: ['dashboard.view', 'maintenance.*', 'work_orders.*', 'equipment.*', 'inventory.view', 'inventory.transaction', 'craftsmen.view', 'reports.view', 'reports.maintenance', 'reports.equipment', 'reports.export'] },
  production_team_leader: { name: 'Production Team Leader', description: 'Supervises production team', level: 6, category: 'Supervision', permissions: ['dashboard.view', 'production.view', 'production.start', 'production.complete', 'production.packaging', 'equipment.view', 'inventory.view', 'inventory.transaction', 'quality.view', 'work_orders.view', 'craftsmen.view', 'reports.view', 'reports.production'] },
  maintenance_team_leader: { name: 'Maintenance Team Leader', description: 'Supervises maintenance team', level: 6, category: 'Supervision', permissions: ['dashboard.view', 'maintenance.view', 'maintenance.complete', 'work_orders.view', 'work_orders.complete', 'equipment.view', 'equipment.edit', 'inventory.view', 'inventory.transaction', 'craftsmen.view', 'reports.view', 'reports.maintenance'] },
  quality_inspector: { name: 'Quality Inspector', description: 'Performs quality inspections', level: 4, category: 'Technical', permissions: ['dashboard.view', 'quality.view', 'quality.inspect', 'quality.ncr_create', 'production.view', 'inventory.view', 'reports.view', 'reports.quality'] },
  maintenance_technician: { name: 'Maintenance Technician', description: 'Performs maintenance work', level: 4, category: 'Technical', permissions: ['dashboard.view', 'maintenance.view', 'maintenance.complete', 'work_orders.view', 'work_orders.complete', 'equipment.view', 'inventory.view', 'inventory.transaction'] },
  machine_operator: { name: 'Machine Operator', description: 'Operates production machinery', level: 3, category: 'Operations', permissions: ['dashboard.view', 'production.view', 'production.start', 'production.complete', 'equipment.view', 'inventory.view', 'quality.view', 'work_orders.view'] },
  ...
  general_worker: { name: 'General Worker', description: 'Basic view-only access', level: 2, category: 'Operations', permissions: ['dashboard.view', 'production.view', 'equipment.view', 'inventory.view', 'work_orders.view'] },
